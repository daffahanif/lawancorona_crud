                    ...
                    <div class="col-lg-8">
                        <div class="card shadow mb-4">
                            ...
                            <div class="card-body">
                                ...
                                $id = $_GET["id"];
                                // echo $id;
                                $query = "SELECT * FROM tb_donasi WHERE id = $id";
                                ...
                                <form action="edit_process.php" method="POST">
                                    ...
                                    <input type="text" class="form-control" placeholder="Nama Donatur" name="nama" required value="<?php echo $data["nama_donatur"]; ?>"><br>
                                    <label for="">Jumlah Donasi</label>
                                    <input type="text" class="form-control" placeholder="10000" name="jumlah" required value="<?php echo $data["jumlah_donasi"]; ?>"><br>
                                    <label for="">Alamat Donatur</label>
                                    <input type="text" class="form-control" placeholder="Alamat Donatur" name="alamat" required value="<?php echo $data["alamat_donatur"]; ?>"><br>
