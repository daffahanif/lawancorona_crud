                        ...
                        <div class="card shadow mb-4">
                            ...
                            <div class="card-body">
                                <form action="add_process.php" method="POST">
                                    ...
                                    <input type="text" class="form-control" placeholder="Umur Pasien" name="umur" required>
                                    <br>
                                    ...
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="radio" name="gender" id="inlineRadio1" value="Perempuan">
                                    ...
                                    <select class="form-control form-control-sm" name="status" required>
                                        ...
                                        <option value="ODP">Orang Dalam Pengawasan</option>
                                        <option value="PDP">Pasien Dalam Pengawasan</option>
                                    </select>
                                    <br>
                                    <label for="">Provinsi</label>
                                    <input type="text" class="form-control" placeholder="Provinsi Pasien" name="provinsi" required>
                                    <br>
                                    <label for="">Warga Negara</label>
                                    <input type="text" class="form-control" placeholder="Warga Negara" name="wn" required>
                                    <br>
                                    <label for="">Dirawat Di</label>
                                    <input type="text" class="form-control" placeholder="Rumah Sakit" name="rs" required> <br>
